...
public class InterruptDemo01 {
    ...
    public static void main(String[] args) {
        try {
            Thread t1 = new MyThread01("t1");  // 新建“线程t1”
            System.out.println(t1.getName() + " (" + t1.getState() + ") is new."); // NEW

            t1.start();                      // 启动“线程t1”
            System.out.println(t1.getName() + " (" + t1.getState() + ") is started."); // RUNNABLE
            ...
            Thread.sleep(300);
            System.out.println(t1.getName() + " (" + t1.getState() + ") is interrupted now."); // TERMINATED
