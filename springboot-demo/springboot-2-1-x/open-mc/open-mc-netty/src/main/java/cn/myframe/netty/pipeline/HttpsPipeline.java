        ...
        // SslProvider provider = OpenSsl.isAlpnSupported() ? SslProvider.OPENSSL : SslProvider.JDK;
         try
         {
             ...
             List<String> ciphers = Arrays.asList
                     ...
                     "AES256-SHA"/*, 
                     "DES-CBC3-SHA"*/);
           // Set<String> cip = OpenSsl.availableCipherSuites();
   //          logger.debug("openssl version:" + OpenSsl.versionString() +"," + OpenSsl.version());
   //          logger.debug( "has ECDHE-RSA-AES128-SHA:" +OpenSsl.isCipherSuiteAvailable("ECDHE-RSA-AES128-SHA"));
             /*for (String string : cip)
             {
                 logger.debug(string);
             }*/
        ...
        //     System.getProperty("java.library.path");
             SslContext sslCtx = SslContextBuilder.forServer(new File(certificateFile), new File(keyFile))
                 //    .trustManager(new File(certificateFile))
