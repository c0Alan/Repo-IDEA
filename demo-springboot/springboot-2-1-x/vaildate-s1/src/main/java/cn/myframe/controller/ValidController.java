...
import cn.myframe.entity.VaildateModel;
...
public class ValidController {
    ...
    public String vaild3(@RequestBody(required = false) VaildateModel vaildModel) {
        Set<ConstraintViolation<VaildateModel>> violationSet = validator.validate(vaildModel);
        for (ConstraintViolation<VaildateModel> model : violationSet) {
