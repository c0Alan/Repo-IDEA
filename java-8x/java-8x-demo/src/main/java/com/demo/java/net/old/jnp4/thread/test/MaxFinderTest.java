package com.demo.java.net.old.jnp4.thread.test;

import static org.junit.Assert.*;

import java.util.concurrent.ExecutionException;

import com.demo.java.net.old.jnp4.thread.MultithreadedMaxFinder;
...
public class MaxFinderTest {
  ...
  public void testOddElement() throws InterruptedException, ExecutionException {
    ...
    Assert.assertEquals(56, MultithreadedMaxFinder.max(data));
  }
