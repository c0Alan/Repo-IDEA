...
public class VehicleArchivesInformation {
    ...
    private BigDecimal qddjgl;

    private String cnzzzl;

    private Short cnzzxs;

    private BigDecimal cnzzzdl;

    private BigDecimal cnzzzdy;

    private BigDecimal cnzzdtdy;

    private String hdwjcd;

    private BigDecimal cdqdxslcgk;

    private BigDecimal cdqdxslcds;
    ...
    public void setClpp2(String clpp2) {
        this.clpp2 = clpp2 == null ? null : clpp2.trim();
    }
    ...
    public Short getBdjcs() {
        return bdjcs;
    }

    public void setBdjcs(Short bdjcs) {
        this.bdjcs = bdjcs;
    }
    ...
    public void setDjzsbh(String djzsbh) {
        this.djzsbh = djzsbh == null ? null : djzsbh.trim();
    }

    public Short getZdjzshs() {
        return zdjzshs;
    }

    public void setZdjzshs(Short zdjzshs) {
    ...
    public void setClly(String clly) {
        this.clly = clly == null ? null : clly.trim();
    }
    ...
    public void setZxxs(String zxxs) {
        this.zxxs = zxxs == null ? null : zxxs.trim();
    }
    ...
    public void setHbdbqk(String hbdbqk) {
        this.hbdbqk = hbdbqk == null ? null : hbdbqk.trim();
    }
    ...
    public void setLlpz1(String llpz1) {
        this.llpz1 = llpz1 == null ? null : llpz1.trim();
    }
    ...
    public void setPzbh1(String pzbh1) {
        this.pzbh1 = pzbh1 == null ? null : pzbh1.trim();
    }
    ...
    public void setLlpz2(String llpz2) {
        this.llpz2 = llpz2 == null ? null : llpz2.trim();
    }
    ...
    public void setPzbh2(String pzbh2) {
        this.pzbh2 = pzbh2 == null ? null : pzbh2.trim();
    }
    ...
    public void setJkpz(String jkpz) {
        this.jkpz = jkpz == null ? null : jkpz.trim();
    }
    ...
    public void setJkpzhm(String jkpzhm) {
        this.jkpzhm = jkpzhm == null ? null : jkpzhm.trim();
    }
    ...
    public void setNszmbh(String nszmbh) {
        this.nszmbh = nszmbh == null ? null : nszmbh.trim();
    }
    ...
    public void setQmbh(String qmbh) {
        this.qmbh = qmbh == null ? null : qmbh.trim();
    }
    ...
    public void setHmbh(String hmbh) {
        this.hmbh = hmbh == null ? null : hmbh.trim();
    }
    ...
    public void setZzxxdz(String zzxxdz) {
        this.zzxxdz = zzxxdz == null ? null : zzxxdz.trim();
    }
    ...
    public void setYzbm2(String yzbm2) {
        this.yzbm2 = yzbm2 == null ? null : yzbm2.trim();
    }
    ...
    public void setZdyzt(String zdyzt) {
        this.zdyzt = zdyzt == null ? null : zdyzt.trim();
    }
    ...
    public void setYxh(String yxh) {
        this.yxh = yxh == null ? null : yxh.trim();
    }
    ...
    public void setDphgzbh(String dphgzbh) {
        this.dphgzbh = dphgzbh == null ? null : dphgzbh.trim();
    }
    ...
    public void setYtsx(String ytsx) {
        this.ytsx = ytsx == null ? null : ytsx.trim();
    }
    ...
    public void setJyhgbzbh(String jyhgbzbh) {
        this.jyhgbzbh = jyhgbzbh == null ? null : jyhgbzbh.trim();
    }
    ...
    public Short getFdjgs() {
        return fdjgs;
    }

    public void setFdjgs(Short fdjgs) {
        this.fdjgs = fdjgs;
    }
    ...
    public void setSfyzhgn(String sfyzhgn) {
        this.sfyzhgn = sfyzhgn == null ? null : sfyzhgn.trim();
    }
    ...
    public void setWxmbc(String wxmbc) {
        this.wxmbc = wxmbc == null ? null : wxmbc.trim();
    }
    ...
    public void setNcdqsy(String ncdqsy) {
        this.ncdqsy = ncdqsy == null ? null : ncdqsy.trim();
    }

    public Date getHpqysj() {
        return hpqysj;
    }

    public void setHpqysj(Date hpqysj) {
        this.hpqysj = hpqysj;
    }

    public String getDzbsxlh() {
        return dzbsxlh;
    }

    public void setDzbsxlh(String dzbsxlh) {
        this.dzbsxlh = dzbsxlh == null ? null : dzbsxlh.trim();
    }
    ...
    public void setSfxny(String sfxny) {
        this.sfxny = sfxny == null ? null : sfxny.trim();
    }
    ...
    public void setXnyzl(String xnyzl) {
        this.xnyzl = xnyzl == null ? null : xnyzl.trim();
    }
    ...
    public void setQddjxh(String qddjxh) {
        this.qddjxh = qddjxh == null ? null : qddjxh.trim();
    }

    public String getQddjh() {
        return qddjh;
    }

    public void setQddjh(String qddjh) {
        this.qddjh = qddjh == null ? null : qddjh.trim();
    }

    public BigDecimal getQddjgl() {
        return qddjgl;
    }

    public void setQddjgl(BigDecimal qddjgl) {
        this.qddjgl = qddjgl;
    }

    public String getCnzzzl() {
        return cnzzzl;
    }

    public void setCnzzzl(String cnzzzl) {
        this.cnzzzl = cnzzzl == null ? null : cnzzzl.trim();
    }

    public Short getCnzzxs() {
        return cnzzxs;
    }

    public void setCnzzxs(Short cnzzxs) {
        this.cnzzxs = cnzzxs;
    }

    public BigDecimal getCnzzzdl() {
        return cnzzzdl;
    }

    public void setCnzzzdl(BigDecimal cnzzzdl) {
        this.cnzzzdl = cnzzzdl;
    }

    public BigDecimal getCnzzzdy() {
        return cnzzzdy;
    }

    public void setCnzzzdy(BigDecimal cnzzzdy) {
        this.cnzzzdy = cnzzzdy;
    }

    public BigDecimal getCnzzdtdy() {
        return cnzzdtdy;
    }

    public void setCnzzdtdy(BigDecimal cnzzdtdy) {
        this.cnzzdtdy = cnzzdtdy;
    }

    public String getHdwjcd() {
        return hdwjcd;
    }

    public void setHdwjcd(String hdwjcd) {
        this.hdwjcd = hdwjcd == null ? null : hdwjcd.trim();
    }

    public BigDecimal getCdqdxslcgk() {
        return cdqdxslcgk;
    }

    public void setCdqdxslcgk(BigDecimal cdqdxslcgk) {
        this.cdqdxslcgk = cdqdxslcgk;
    }

    public BigDecimal getCdqdxslcds() {
        return cdqdxslcds;
    }

    public void setCdqdxslcds(BigDecimal cdqdxslcds) {
        this.cdqdxslcds = cdqdxslcds;
    }

    public String getFmzp() {
        return fmzp;
    }

    public void setFmzp(String fmzp) {
        this.fmzp = fmzp == null ? null : fmzp.trim();
    }
