    ...
    @Results(
            {
                ...
                @Result(column="name",property="name"),
                @Result(column="age",property="age"),
                @Result(column="address_id",property="address",one=@One(select="com.mybatis.demo02.mapper.AddressMapper.findById"))
            }
    )
    ...
    @Results(
            {
                ...
                @Result(column="name",property="name"),
                @Result(column="age",property="age"),
                @Result(column="grade_id",property="grade",one=@One(select="com.mybatis.demo02.mapper.GradeMapper.findById"))
            }
    )
