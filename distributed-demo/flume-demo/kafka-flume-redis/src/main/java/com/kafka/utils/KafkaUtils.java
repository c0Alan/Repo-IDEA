...
import com.kafka.consts.Constants;
import com.model.IpranAlarm;
...
//        props.put("group.id", "test");
    ...
    public static void sendMsgToKafka(String msg) {
        producer.send(new ProducerRecord<String, String>(Constants.TOPIC_NAME, JSONObject.toJSONString(new IpranAlarm("999"))));
        producer.flush(); // 必须加 flush 才会发送数据
    }
