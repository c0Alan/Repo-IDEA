package com.demo.springcloud.java8.net.post;
...
/**
 * 使用 URLConnection 发送post请求
 *
 * @author liuxilin
 * @date 2022/8/12 21:07
 */
public class PostTest {
    public static void main(String[] args) throws IOException {
        String propsFilename = args.length > 0 ? args[0] : "data/post.properties";
