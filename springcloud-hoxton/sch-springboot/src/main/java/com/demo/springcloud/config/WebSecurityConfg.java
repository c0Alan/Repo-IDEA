...
import com.demo.springcloud.security.CustomLogoutSuccessHandler;
...
public class WebSecurityConfg extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http//1、配置权限认证
                ...
                .antMatchers("/sysUser/saveUser").permitAll()
                .anyRequest() //任何其它请求
                .authenticated() //都需要身份认证
                .and()
                //2、登录配置表单认证方式
                .formLogin()
                .loginPage("/security/login")//自定义登录页面的url
                ...
                //4、session管理
                .sessionManagement()
                .invalidSessionUrl("/security/login") //失效后跳转到登陆页面
